...
>>>>>>> 482f2602e5ea3805cc02b01b88080496a1a2a5e1
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center justify-center relative">
            ...
            <div className="relative w-48 h-48 flex items-center justify-center">
              ...
              {/* 中央 Logo */}
              <div className="z-10 bg-black p-4 rounded-full border border-gray-700">
                 <img src="https://duk.tw/ZhYY5L.png" alt="Kaguya Logo" className="w-20 h-20 object-contain drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]" />
              </div>
            </div>
              ...
              <div className="space-y-4 font-mono text-sm font-bold">
                ...
                <div>
                  <div className="flex justify-between mb-1 text-pink-300">
                    <span className="flex items-center gap-2"><Zap size={14}/> 手速 (SPEED)</span>
                    <span>MAX</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-1 text-purple-300">
                    <span className="flex items-center gap-2"><Box size={14}/> 包裝 (PACKING)</span>
                    <span>SSS+</span>
                  </div>
                  <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
