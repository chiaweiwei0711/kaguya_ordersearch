...
const CATEGORIES: { title: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    title: "交易條款",
    items: [
      { q: "填單送出後可以取消嗎？", a: "本站商品為日本代購預購，結單後即向日本方下訂，屬依消費者要求所為之客製化給付，不適用七天猶豫期間（鑑賞期），送出後恕不接受取消。結單前需要修改請私訊官賴。" },
      { q: "倉儲費怎麼算？", a: "商品抵台後提供 30 天免費倉儲，逾期每件每天酌收 5 元倉儲費。" },
      { q: "日方砍單或缺貨怎麼辦？", a: "我們會主動通知，並全額退還該品項款項。" },
    ],
  },
  {
    title: "其他",
